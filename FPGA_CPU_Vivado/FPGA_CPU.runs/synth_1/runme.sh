...
HD_PWD='C:/Users/eddie/FPGA_CPU/FPGA_CPU_Vivado/FPGA_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log operating_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source operating_system.tcl
