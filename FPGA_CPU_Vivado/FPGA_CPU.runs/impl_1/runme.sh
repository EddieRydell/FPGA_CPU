...
HD_PWD='C:/Users/eddie/FPGA_CPU/FPGA_CPU_Vivado/FPGA_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log operating_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source operating_system.tcl -notrace
