...
#
# Script generated by Vivado on Fri Oct 11 23:20:23 -0600 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/eddie/FPGA_CPU/FPGA_CPU_Vivado/FPGA_CPU.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
